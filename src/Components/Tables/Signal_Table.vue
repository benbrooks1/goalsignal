        ...
        <div v-for="item in tableData" :key="item.id">
          ...
          >
            ...
            <div class="Scanner_Alert_Circle alert-circle-outer">
              <span
                v-if=" returnUser.appData.signalAlerts.some(alert => {return alert.matchId === child.id && (alert.signalName === returnSelectedSignal.name)})  "
                class="alert-circle alert-green"
              ></span>
              <span v-else class="alert-circle alert-red"></span>
            </div>
            <div class="Scanner_Odds table-each-item live-odd-data-out">
              ...
              >
                <span v-for="value in odds.odds" class="live-odd-data">
                  <span class="strong">({{value.value}})</span>
                </span>
              </div>
            </div>
            ...
            <match-flow-item :child="child" type="Possession" />
